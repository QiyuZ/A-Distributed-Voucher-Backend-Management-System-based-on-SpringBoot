...
import com.qiyu.passbook.passbook.service.IHBasePassService;
...
/**
 * <h1>Pass HBase service implement</h1>
 * Created by Qiyu.
 */
@Slf4j
@Service
public class HBasePassServiceImpl implements IHBasePassService {
    ...
    public boolean dropPassTemplateToHBase(PassTemplate passTemplate) {
        ...
        if (null == passTemplate) {
            log.warn("No such pass-template");
            return false;
        }
        ...
        /***
         * check whether this key is exited or not
         */
        try {
