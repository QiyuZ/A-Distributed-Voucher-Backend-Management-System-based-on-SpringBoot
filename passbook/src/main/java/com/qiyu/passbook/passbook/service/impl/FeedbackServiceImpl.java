...
import com.qiyu.passbook.passbook.mapper.FeedbackRowMapper;
import com.qiyu.passbook.passbook.service.IFeedbackService;
import com.qiyu.passbook.passbook.utils.RowKeyGenUtil;
...
public class FeedbackServiceImpl implements IFeedbackService {
    ...
    public Response getFeedback(Long userId) {
        ...
        /***
         * "get" can just can one piece of data, so we need to scan
         */
