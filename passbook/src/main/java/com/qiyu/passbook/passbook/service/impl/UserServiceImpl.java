...
import com.qiyu.passbook.passbook.service.IUserService;
...
public class UserServiceImpl implements IUserService {
    ...
    public Response createUser(User user) throws Exception {
        ...
        byte[] FAMILY_B = Constants.UserTable.FAMILY_B.getBytes(); //the type in HBase is byte, so transform it to byte firstly
        ...
        put.addColumn(FAMILY_B, NAME, Bytes.toBytes(user.getBaseInfo().getName())); //find FAMILY_B->NAME, then put value in
